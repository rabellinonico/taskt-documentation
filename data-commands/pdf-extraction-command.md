...
| ---                    | ---               | ---           | ---       |
|Please indicate the PDF file path or PDF file URL|Enter or Select the path to the applicable file or enter file URL.|C:\temp\myfile.pdf , [vFilePath] or https://temp.com/myfile.pdf||
|Please select source type of PDF file|Select source type of PDF file|Select **File Path**, **File URL**||
