...
|Please define the input to be added to the variable|Enter the input that the variable's value should be set to.|Hello or [vNum]+1|You can use variables in input if you encase them within brackets [vName].  You can also perform basic math operations.|
