...
|Please set the current index of the variable|Enter the input that the variable's index should be set to.|1, 2, etc.|You can use variables in input if you encase them within brackets {vName}.  You can also perform basic math operations.|
